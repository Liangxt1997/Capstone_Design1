<?php $__env->startSection('nav'); ?>
    <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite><?php echo e(trans('admin.liuyan')); ?></cite></a>
            </span>
...
<?php $__env->startSection('content'); ?>
    <div class="x-body">
        ...
        <xblock>
            <?php if($isCreate): ?>
                <?php $__env->startComponent('components.action_add', ['route'=>'feedbacks.add']); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <?php if($isEdit): ?>
                            <?php $__env->startComponent('components.action_edit', ['route'=>'feedbacks.edit', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>

                        <?php if($data['isDelete']): ?>
                            <?php $__env->startComponent('components.action_delete', ['route'=>'feedbacks.delete', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\used_product_students\used_product_student\resources\views/admin/feedbacks/list.blade.php ENDPATH**/ ?>