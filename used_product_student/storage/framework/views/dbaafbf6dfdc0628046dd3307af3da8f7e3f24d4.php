        ...
        <div class="layui-form-item">
            ...
            <?php switch($field['type']):
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" placeholder="시작일" value="<?php echo e($field["value"][0]); ?>" name="<?php echo e($field['name']); ?>_s" id="<?php echo e($field['name']); ?>_s">
                </div>
                <div class="layui-input-inline">
                    <input class="layui-input" placeholder="마감일" value="<?php echo e($field["value"][1]); ?>" name="<?php echo e($field['name']); ?>_e" id="<?php echo e($field['name']); ?>_e">
                </div>
...
<?php /**PATH D:\used_product_students\used_product_student\resources\views/components/search_bar.blade.php ENDPATH**/ ?>