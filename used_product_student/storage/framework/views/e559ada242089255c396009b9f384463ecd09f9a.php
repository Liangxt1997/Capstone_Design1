...
<?php $__env->startSection('content'); ?>
    <div class="x-body">
        ...
        <xblock>
            <?php if($isCreate): ?>
                <?php $__env->startComponent('components.action_add', ['route'=>'orders.add']); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php endif; ?>
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <?php if($isEdit && $data->status > 1 && $data->status != 98 && $data->status != 99): ?>
                            <?php $__env->startComponent('components.action_edit', ['route'=>'orders.edit', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                            状态
                        <?php endif; ?>
                        ...
                        <?php if($data['isDelete']): ?>
                            <?php $__env->startComponent('components.action_delete', ['route'=>'orders.delete', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\student_other_work\book_product_project\book_product_admin\resources\views/admin/orders/list.blade.php ENDPATH**/ ?>