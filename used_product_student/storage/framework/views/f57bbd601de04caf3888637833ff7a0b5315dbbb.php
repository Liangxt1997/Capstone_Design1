    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <div class="site-demo-upbar">
                <input id="<?php echo e($name); ?>_file" type="file" name="file" class="layui-upload-file" >
            </div>
        </div>
    </div>
        <div class="layui-form-item">
            <label  class="layui-form-label"><?php echo e($description); ?> 썸네일
            </label>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            layui.use([ 'upload'], function() {
                ...
                //图片上传接口
                layui.upload({
                    elem:"#<?php echo e($name); ?>_file",
                    url: '<?php echo e(route('file.upload')); ?>' //上传接口
                    , success: function (res) { //上传成功后的回调
                        console.log('<?php echo e($name); ?>');
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
                        <textarea id="<?php echo e($name); ?>" name="<?php echo e($name); ?>"
                                  placeholder="입력하세요." class="layui-textarea fly-editor" style="height: 260px;"><?php echo e($value); ?></textarea>
        </div>
    </div>
    <?php $__env->startPush('scripts'); ?>
        <script>
        ...
        <div class="layui-input-inline" >
            <select required="" name="<?php echo e($name); ?>">
                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($value == $tag->id): ?>
                        <option selected="selected" value="<?php echo e($tag->id); ?>"><?php echo e($tag->name); ?></option>
                    <?php else: ?>
...
<?php endswitch; ?>
<?php /**PATH D:\used_product_students\used_product_student\resources\views/components/form_item.blade.php ENDPATH**/ ?>