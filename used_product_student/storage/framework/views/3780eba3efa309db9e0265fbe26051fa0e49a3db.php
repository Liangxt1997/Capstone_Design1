<?php $__env->startSection('nav'); ?>
    <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite><?php echo e(trans('admin.system')); ?></cite></a>
              <a><cite><?php echo e(trans('admin.m_g')); ?></cite></a>
            </span>
...
<?php $__env->startSection('content'); ?>
    <div class="x-body">
        ...
        <xblock>
            <?php if($isCreate): ?>
                <?php $__env->startComponent('components.action_add', ['route'=>'users.add']); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <?php if($isEdit): ?>
                            <?php $__env->startComponent('components.action_edit', ['route'=>'users.edit', 'icon' => '密码安全', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>
                        
                            <?php $__env->startComponent('components.action_information', ['route'=>'users.information', 'icon' => '完善商家信息', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php if($data['isDelete']): ?>
                            <?php $__env->startComponent('components.action_delete', ['route'=>'users.delete', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\used_product_students\used_product_student\resources\views/admin/users/list.blade.php ENDPATH**/ ?>