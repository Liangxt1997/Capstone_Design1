...
<html>
    ...
    <body style="background-color: #d17e42">
        <div class="x-box">
            ...
            <div class="x-mid">
                <div class="input">
                    <form method="POST" action="<?php echo e(route('register.post')); ?>" class="layui-form">
...
<?php /**PATH D:\student_other_work\web\used_product_students\used_product_student\resources\views/auth/register.blade.php ENDPATH**/ ?>