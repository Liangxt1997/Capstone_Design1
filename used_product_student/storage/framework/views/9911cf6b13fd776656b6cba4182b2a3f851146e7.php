            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="_dash_navigation">
                        <ul>
                            <li ><a href="<?php echo e(route('collection')); ?>">我收藏的</a></li>
                            <li class="active"><a href="<?php echo e(route('download')); ?>">我下载的<span class="_counts"><?php echo e($num); ?></span></a></li>
...
<?php echo $__env->make('home.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\student_other_work\web\material_manage\material_manage\resources\views/home/download.blade.php ENDPATH**/ ?>