<ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
    ...
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            <dd class="">
                <a href="javascript:;" _href="<?php echo e(route('members')); ?>">
                    <cite>会员列表</cite>
                </a>
            </dd>
            <dd class="">
        ...
        <dl class="layui-nav-child">
            <dd class="">
            <dd class="">
                <a href="javascript:;" _href="<?php echo e(route('address')); ?>">
                    <cite>地址管理</cite>
                </a>
            </dd>
            </dd>
        ...
        <dl class="layui-nav-child">
            <dd class="">
            <dd class="">
                <a href="javascript:;" _href="<?php echo e(route('orders')); ?>">
                    <cite>订单列管理</cite>
                </a>
            </dd>
            </dd>
    ...
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            ...
            <dd class="">
            <dd class="">
                <a href="javascript:;" _href="<?php echo e(route('activities')); ?>">
                    <cite>优惠活动管理</cite>
                </a>
            </dd>
            </dd>
...
<?php /**PATH D:\student_other_work\book_product_project\book_product_admin\resources\views/layouts/menus.blade.php ENDPATH**/ ?>