...
<?php $__env->startSection('content'); ?>
    <div class="x-body">
        ...
        <xblock>
            <?php if($isCreate): ?>
                <?php $__env->startComponent('components.action_add', ['route'=>'suppliers.add']); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <?php if($isEdit): ?>
                            <?php $__env->startComponent('components.action_edit', ['route'=>'suppliers.edit', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>

                        <?php if($data['isDelete']): ?>
                            <?php $__env->startComponent('components.action_delete', ['route'=>'suppliers.delete', 'id'=>$data->id]); ?>
                            <?php echo $__env->renderComponent(); ?>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\other_work\book_product_project\book_product_admin\resources\views/admin/suppliers/list.blade.php ENDPATH**/ ?>