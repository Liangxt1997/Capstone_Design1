            ...
            <ul class="layui-nav" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child"> <!-- 二级菜单 -->
                        ...
                        <dd><a href="<?php echo e(route('logout')); ?>">切换帐号</a></dd>
                        <dd><a href="<?php echo e(route('logout')); ?>">退出</a></dd>
                    </dl>
                </li>
...
<?php /**PATH D:\student_other_work\book_product_project\book_product_admin\resources\views/layouts/admin.blade.php ENDPATH**/ ?>