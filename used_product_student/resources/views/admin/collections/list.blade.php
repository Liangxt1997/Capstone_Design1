...
@section('nav')
    <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite>{{trans('admin.want')}}</cite></a>
            </span>
...
@section('content')
    <div class="x-body">
        ...
        <xblock>
            @if ($isCreate)
                @component('components.action_add', ['route'=>'collections.add'])
                @endcomponent
            @endif
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        @if ($isEdit && $data->status > 1 && $data->status != 98 && $data->status != 99)
                            @component('components.action_edit', ['route'=>'collections.edit', 'id'=>$data->id])
                            @endcomponent
                            状态
                        @endif
...
{{--                            @endif--}}
                        ...
                        @if ($data['isDelete'])
                            @component('components.action_delete', ['route'=>'collections.delete', 'id'=>$data->id])
                            @endcomponent
                        @endif
                    </td>
                </tr>
