...
@section('nav')
    <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite>{{trans('admin.system')}}</cite></a>
              <a><cite>{{trans('admin.m_g')}}</cite></a>
            </span>
            ...
            @foreach($list as $data)
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        @if ($isEdit)
                            @component('components.action_edit', ['route'=>'users.edit', 'icon' => '密码安全', 'id'=>$data->id])
                            @endcomponent
                        @endif
                        {{--用户完善商家信息操作--}}
                            @component('components.action_information', ['route'=>'users.information', 'icon' => '完善商家信息', 'id'=>$data->id])
                            @endcomponent
                        @if ($data['isDelete'])
                            @component('components.action_delete', ['route'=>'users.delete', 'id'=>$data->id])
                            @endcomponent
                        @endif
                    </td>
                </tr>
