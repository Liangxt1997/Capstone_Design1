...
@section('nav')
    <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite>{{trans('admin.product')}}</cite></a>
              <a><cite>{{trans('admin.product_list')}}</cite></a>
            </span>
...
@section('content')
    <div class="x-body">
        ...
        <xblock>
            @if ($isCreate)
                @component('components.action_add', ['route'=>'products.add'])
                @endcomponent
            @endif
            ...
            @foreach($list as $data)
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        @if ($isEdit)
                            @component('components.action_edit', ['route'=>'products.edit', 'id'=>$data->id])
                            @endcomponent
                        @endif

                        @if ($data['isDelete'])
                            @component('components.action_delete', ['route'=>'products.delete', 'id'=>$data->id])
                            @endcomponent
                        @endif
                    </td>
                </tr>
