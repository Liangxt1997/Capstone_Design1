...
@section('content')
    <div class="x-body">
        ...
        <xblock>
            {{--@if ($isCreate)--}}
                {{--@component('components.action_add', ['route'=>'members.add'])--}}
                {{--@endcomponent--}}
            {{--@endif--}}
            ...
            @foreach($list as $data)
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        {{--@if ($isEdit)--}}
                            {{--@component('components.action_edit', ['route'=>'members.edit', 'id'=>$data->id])--}}
                            {{--@endcomponent--}}
                        {{--@endif--}}

                        @if ($data['isDelete'])
                            @component('components.action_delete', ['route'=>'members.delete', 'id'=>$data->id])
                            @endcomponent
                        @endif
                    </td>
                </tr>
