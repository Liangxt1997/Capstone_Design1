...
@section('nav')
    <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite>{{trans('admin.cate')}}</cite></a>
              <a><cite>{{trans('admin.cate')}}</cite></a>
            </span>
...
@section('content')
    <div class="x-body">
        ...
        <xblock>
            @if ($isCreate)
                @component('components.action_add', ['route'=>'categories.add'])
                @endcomponent
            @endif
            ...
            @foreach($list as $data)
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        @if ($isEdit)
                            @component('components.action_edit', ['route'=>'categories.edit', 'id'=>$data->id])
                            @endcomponent
                        @endif

                        @if ($data['isDelete'])
                            @component('components.action_delete', ['route'=>'categories.delete', 'id'=>$data->id])
                            @endcomponent
                        @endif
                    </td>
                </tr>
